...
function authenticate() {
    params="vk_access_token_settings=${5:-}&vk_app_id=7784361&vk_are_notifications_enabled=${6:-0}&vk_is_app_user=${7:-0}&vk_is_favorite=${8:-0}&vk_language=${9:-ru}&vk_platform=${10:-desktop_web}&vk_ref=$4&vk_ts=$3&vk_user_id=$2&sign=$1"
    echo "$params"
}
...
# 4 - port: (integer): <port>
function add_server() {
    _get "addServer?game=$1&name=$2&ip=$3&port=$4&"
}
